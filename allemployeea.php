                ...
                <div  style="margin-left: 15px; align-items: center;">
                    <div class="col-md-8 d-flex">
                        <div class="search" style="width: 500px;">
                            ...
                            <form action="allemployeea.php" method="post">
                                            ...
                                            <div class="d-flex">
                                                <div class="my-2 p-1">
                                                    ...
                                                    <div>
                                                        ...
                                                        <a href="update_employee.php?emp_id=' . $row["emp_id"] . '">
                                                            <button type="button" class="btn btn-outline-primary">See & Update Details</button>
                                                        </a>
                                                        <a href="delete_employee.php?emp_id=' . $row["emp_id"] . '">
